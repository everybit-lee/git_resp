                        ...
                        for t2team in t2teams:
                            ...
                            if re_t2>0:
                                ...
                                if len(res)>0:
                                    ...
                                    if t2team[2] in list:
                                        sqlstr = "update rateT4_kr_nr set " + rr + "=%s where Tspan=%s and Area=%s and T1=%s and T2=%s"
                                        ...
                                        sqlstr="insert into rateT4_kr_nr(Tspan,Area,T1,T2," + rr + ") values(%s,%s,%s,%s,%s)"
