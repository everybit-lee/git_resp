        ...
        for t1team in t1teams: #对每个t1team，循环，查找t2team 中的数据，其中t2team 是只用ts而不管field的，即跨field查找
            ...
            if re_t1 > 0:
                ...
                while k<=0.41:
                    ...
                    cur.execute(sqlstr, (ts1,area,t1team[2]))
                        ...
                        for t2team in t2teams:
                            ...
                            if re_t2>0:
                                ...
                                if len(res)>0:
                                    ...
                                    if t2team[2] in list:
                                        sqlstr = "update ratet5_kr_nr set " + rr + "=%s where Tspan=%s and Area=%s and T1=%s and T2=%s"
                                        ...
                                        sqlstr="insert into rateT5_kr_nr(Tspan,Area,T1,T2," + rr + ") values(%s,%s,%s,%s,%s)"
